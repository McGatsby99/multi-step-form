    ...
    <div className='container'>
        <nav>
          <div className="nav-container">
            ...
            <div className="steps">
              <span className={`page-number ${ activePage === "2"? 'active': ''}`}><p>2</p></span>
              <div className='text'>
                <p>STEP 2</p>
            ...
            <div className="steps">
              <span className={`page-number ${ activePage === "3"? 'active': ''}`}><p>3</p></span>
              <div className='text'>
                <p>STEP 3</p>
            ...
            <div className="steps">
              <span className={`page-number ${ activePage === "4"? 'active': ''}`}><p>4</p></span>
              <div className='text'>
                <p>STEP 4</p>
